      ...
      <div className="calculator">
        <div className="calculator__wrap">
          ...
          <div className="calculatorUI">
            ...
            <button type="button" onClick={this.buttonClicked} value="/" className="btn--opaque">÷</button>
            ...
            <button type="button" onClick={this.buttonClicked} value="x" className="btn--opaque">x</button>
            ...
            <button type="button" onClick={this.buttonClicked} value="+" className="btn--opaque">+</button>
            <button type="button" onClick={this.buttonClicked} value="0" className="btn--large">0</button>
            <button type="button" onClick={this.buttonClicked} value=".">.</button>
            <button type="button" onClick={this.buttonClicked} value="=" className="btn--opaque">=</button>
          </div>
        </div>
